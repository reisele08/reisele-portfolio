...
class Projects extends Component {
  render(){
    return (
      <div className= "projects-page" style={{width: '100%', margin: 'auto'}}>
      <Grid className="projects-row-1">
        ...
        <CardText>
          <h3 className="projects-h">Cradle</h3>
      ...
      <Card shadow={1} style={{width: '512px', margin: 'auto'}}>
        ...
        <CardText>
          <h3 className="projects-h">Weather-Map</h3>
      ...
      <Card shadow={1} style={{width: '512px', margin: 'auto'}}>
        ...
        <CardText>
          <h3 className="projects-h">Decaf Compiler</h3>
